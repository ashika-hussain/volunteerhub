...
import ie.setu.volunteerhub.utils.readImageUri
import ie.setu.volunteerhub.utils.showImagePicker
...
class Home : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(setOf(R.id.eventFragment,
    ...
    fun shareApp(item: MenuItem) {
        val message = "Hey, download this cool app for volunteers: https://yourappstorelink.com"
