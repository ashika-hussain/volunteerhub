package ie.setu.volunteerhub.ui.auth
...
import ie.setu.volunteerhub.firebase.FirebaseAuthManager

public class LoginRegisterViewModel (app: Application) : AndroidViewModel(app) {
